...
//        array.recycle();
    ...
    public void setCropCorners(boolean topLeft, boolean bottomLeft, boolean topRight, boolean bottomRight, int type, int scaleType, int radius) {
        this.type = type;
        this.scaleType = scaleType;
        this.corners_top_left = topLeft;
        this.corners_top_right = topRight;
        this.corners_bottom_left = bottomLeft;
        this.corners_bottom_right = bottomRight;
        this.borderRadius = array.getDimensionPixelSize(radius,
                (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, BODER_RADIUS_DEFAULT,
                        getResources().getDisplayMetrics()));
//        this.array.recycle();
    }
