...
public class CircleRadiusImageView extends ImageView {
    ...
    public CircleRadiusImageView(Context context) {
        this(context, null);
    }

    public CircleRadiusImageView(Context context, AttributeSet attrs) {
        this(context, attrs, -1);
    }

    public CircleRadiusImageView(Context context, AttributeSet attrs, int defStyle) {
